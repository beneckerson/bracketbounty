...
const TEAM_CODE_MAP: Record<string, { code: string; abbreviation: string; color: string }> = {
  ...
  // College Football Teams (common CFP contenders) - use underscore format to match sync-teams
  'Notre Dame Fighting Irish': { code: 'NOTRE_DAME_FIGHTING_IRISH', abbreviation: 'ND', color: 'team-blue' },
  'Ohio State Buckeyes': { code: 'OHIO_STATE_BUCKEYES', abbreviation: 'OSU', color: 'team-red' },
  'Penn State Nittany Lions': { code: 'PENN_STATE_NITTANY_LIONS', abbreviation: 'PSU', color: 'team-blue' },
  'Georgia Bulldogs': { code: 'GEORGIA_BULLDOGS', abbreviation: 'UGA', color: 'team-red' },
  'Texas Longhorns': { code: 'TEXAS_LONGHORNS', abbreviation: 'TEX', color: 'team-orange' },
  'Oregon Ducks': { code: 'OREGON_DUCKS', abbreviation: 'ORE', color: 'team-green' },
  'Tennessee Volunteers': { code: 'TENNESSEE_VOLUNTEERS', abbreviation: 'TENN', color: 'team-orange' },
  'Clemson Tigers': { code: 'CLEMSON_TIGERS', abbreviation: 'CLEM', color: 'team-purple' },
  'Michigan Wolverines': { code: 'MICHIGAN_WOLVERINES', abbreviation: 'MICH', color: 'team-blue' },
  'Alabama Crimson Tide': { code: 'ALABAMA_CRIMSON_TIDE', abbreviation: 'BAMA', color: 'team-red' },
  'Arizona State Sun Devils': { code: 'ARIZONA_STATE_SUN_DEVILS', abbreviation: 'ASU', color: 'team-red' },
  'Indiana Hoosiers': { code: 'INDIANA_HOOSIERS', abbreviation: 'IND', color: 'team-red' },
  'Boise State Broncos': { code: 'BOISE_STATE_BRONCOS', abbreviation: 'BSU', color: 'team-blue' },
  'SMU Mustangs': { code: 'SMU_MUSTANGS', abbreviation: 'SMU', color: 'team-blue' },
  'Miami Hurricanes': { code: 'MIAMI_HURRICANES', abbreviation: 'MIA', color: 'team-orange' },
};
