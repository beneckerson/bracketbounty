...
const features = [
  {
    ...
    title: "Capture Mode",
    description:
      "When a team covers the spread, you capture your opponent's teams. Underdogs can capture even when they lose.",
    color: "text-capture",
  },
  {
    icon: Trophy,
    ...
    <section className="py-20 px-4 bg-card">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="font-fugaz text-5xl md:text-6xl text-foreground tracking-wide mb-4">HOW IT WORKS</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Create a pool, invite friends, get assigned teams, and compete through the playoffs. The last one standing
            wins.
          </p>
        </div>
